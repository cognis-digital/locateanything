#!/usr/bin/env sh
# Universal installer for locateanything. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/locateanything.git"
echo "Installing locateanything ..."
...
echo "Done. Run: locateanything --help"
